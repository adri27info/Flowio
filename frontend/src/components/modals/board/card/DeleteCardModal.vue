<template>
    <div v-if="action == 'deleteCard'" class="modal fade" id="deleteCardModal" tabindex="-1" data-bs-backdrop="static"
        aria-hidden="true">
...
import DeleteCardComponent from "@/components/board/card/DeleteCardComponent.vue";
...
const { resetAndCloseModal } = useModalWatcher();
const storeApp = appStore()
const actionEntity = "deleteCard"
