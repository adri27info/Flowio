<template>
    <div v-if="action == 'editCard'" class="modal fade" id="editCardModal" tabindex="-1" data-bs-backdrop="static"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <EditCardComponent @clearForm="clearFormEditCard" />
                </div>
            </div>
        </div>
    </div>
...
import EditCardComponent from "@/components/forms/board/card/EditCardComponent.vue";
