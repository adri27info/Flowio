<template>
    <div v-if="action == 'editWorkspace'" class="modal fade" id="editWorkspaceModal" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <EditWorkspaceComponent @clearForm="clearFormEditWorkspace" />
                </div>
            </div>
        </div>
    </div>
...
import EditWorkspaceComponent from "@/components/forms/workspace/EditWorkspaceComponent.vue";
...
const actionEntity = "editWorkspace"
